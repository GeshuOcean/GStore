package com.gstore.controller.common.interceptor;
...
//            httpServletRequest这个参数的map，里面的value返回的是一个String[]数组
        ...
        if(user == null || (user.getRole().intValue() != Const.Role.ROLE_ADMIN)){
            ...
            httpServletResponse.setContentType("application/json;charset=UTF-8");//这里要设置返回值类型，因为全部是json接口
