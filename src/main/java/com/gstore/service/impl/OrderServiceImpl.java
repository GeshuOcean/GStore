...
import com.gstore.dao.*;
import com.gstore.pojo.*;
import com.gstore.service.IOrderService;
import com.gstore.util.BigDecimalUtil;
import com.gstore.util.DateTimeUtil;
import com.gstore.util.FTPUtil;
import com.gstore.util.PropertiesUtil;
import com.gstore.vo.OrderItemVo;
import com.gstore.vo.OrderProductVo;
import com.gstore.vo.OrderVo;
import com.gstore.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse<List<OrderItem>> getCartOrderItem(Integer userId,List<Cart> cartList){
        ...
        for(Cart cartItem : cartList){
            ...
            if (Const.ProductStatusEnum.ON_SALE.getCode() != product.getStatus()){//判断产品在线否
                return ServerResponse.createByErrorMessage("产品"+product.getName()+"不在线");
    ...
    public ServerResponse pay(Long orderNo,Integer userId,String path){
        ...
        resultMap.put("orderNo",String.valueOf(order.getOrderNo()));
            ...
            String subject = new StringBuilder().append("GStore扫码支付，订单号：").append(outTradeNo).toString();
    ...
    public ServerResponse aliCallback(Map<String,String> params){
        ...
        if(order == null){
            return ServerResponse.createByErrorMessage("非我商城订单，回调请忽略");
        }
    ...
    public void closeOrder(int hour) {
        ...
        for (Order order : orderList) {
            ...
            for (OrderItem orderItem : orderItemList){
                //用主键做where条件，防止锁表。同时必须支持Mysql的InnoDB
